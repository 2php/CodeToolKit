...
#define g_free free
#define g_new0(TYPE,num) calloc(num, sizeof(TYPE))

#define g_return_val_if_fail(pred,val) if (!(pred)) return (val)
#define g_return_if_fail(pred) if (!(pred)) return
...
/**
 * remove gnet_uri_hash, as it uses non-trivial glib functions, but is
 * not used by libmms
 **/
#if 0
/**
...
#endif /* #if 0, removing gnet_uri_hash definition */
...
/**
 * remove gnet_uri_get_string, as it uses non-trivial glib functions, but is
 * not used by libmms
 **/
#if 0
/**
...
#endif /* #if 0, removing gnet_uri_get_string definition */
